...
namespace PortalRSApi.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        {
            Customers valueExists = NameExists(customers);

            if (valueExists == null && !customers.Name.ToLower().Equals("3con"))
            {
            ...
            string msg = valueExists == null ? "Name inválido." : "Name já existe.";
        ...
        private Customers NameExists(Customers customers)
        {
            return _db.Customers.Where(c => c.Name == customers.Name).FirstOrDefault(); ;
        }
    }
}
